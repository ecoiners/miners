...
const CreateView: FC<CreateViewProps> = ({ setOpenCreateModal }) => {
 ...
 //   }
  ...
  return (
    <>
      {isLoading && (
        <div className="absolute top-0 left-0 z-50 flex h-screen w-full items-center justify-center bg-slate-900/70 backdrop-blur-md">
          <ClipLoader />
        </div>
      )}
          ...
          <div className="container mx-auto max-w-5xl bg-slate-800/50 backdrop-blur-2xl rounded-2xl overflow-hidden">
            <div className="grid gap-10 lg:grid-cols-2">
              ...
              <div className="flex flex-col p-8 lg:p-10">
                ...
                <InputView
                  name="Nama Token"
                  placeholder="contoh: EcoRop"
                  clickHandle={(e) => handleFormFieldChange("name", e)}
                />
                <InputView
                  name="Symbol"
                  placeholder="contoh: ECRP"
